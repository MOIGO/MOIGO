...
public class PostReply implements java.io.Serializable{
	...
	public String toString() {
		return "PostReply [replyNo=" + replyNo + ", postNo=" + postNo + ", memberNo=" + memberNo + ", content="
				+ content + ", submitDate=" + submitDate + "]";
	}
	public PostReply(String replyNo, String postNo, String memberNo, String content, Date submitDate) {
		super();
		this.replyNo = replyNo;
		this.postNo = postNo;
		this.memberNo = memberNo;
